...
module Puppet::Provider::Brocade_messages
  ...
  CONFIG_EXISTS_DEBUG="Puppet::Provider::brocade_config: Verifying whether or not a Brocade config with cfgname: %s exists."
  ...
  CONFIG_MEMBERSHIP_EXISTS_DEBUG="Puppet::Provider::brocade_config_membership: Verifying if zonename: %s is member of Brocade Config with cfgname: %s"
